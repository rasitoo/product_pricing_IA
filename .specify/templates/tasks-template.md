...
**Tests**: Include test tasks by default. Tests are REQUIRED by constitution for core logic and external API integrations.
...
- [ ] T002 Initialize Python environment with uv (create/sync venv and lock workflow)
- [ ] T003 Add initial project libraries with `uv add` according to plan requirements
...
- [ ] T011 Configure secret management and API key loading (no plaintext keys)
- [ ] T012 Define cost guardrails for paid API usage (budget cap, stop conditions, alerting)
...
- [ ] T020 [US1] Add logging and per-request cost tracking for user story 1
- [ ] T021 [US1] Update parallel notebook summary with US1 methodology and results
...
- [ ] T028 [US2] Update parallel notebook summary with US2 methodology and results
...
- [ ] T034 [US3] Update parallel notebook summary with US3 methodology and results
...
- [ ] TXXX [P] Additional unit tests for optimization logic in tests/unit/
- [ ] TXXX Security hardening
- [ ] TXXX Verify no direct `pip install` usage in project workflows; dependencies are added via `uv add`
- [ ] TXXX Validate API key handling and cost guardrails under failure scenarios
- [ ] TXXX Consolidate final notebook summary with cross-story quality/cost comparison
